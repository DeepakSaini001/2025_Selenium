...
public interface Constants {
	...
	public static final String Timestamp = new SimpleDateFormat("yyyy-MMM-dd_HH-mm-ss").format(new Date());
	public static final String ReportName = "TestExecutionReport_" + Timestamp + ".html";
