...
public class TC_03_MyProtien_validation_repeat_BaseTest extends BaseTest {

	@Test(groups = { "regression" }, priority = 2, description = "TC_03_Login with Exisitng User in Application")
	public void TC_03_loginIntoApplication_using_Credintails() {
	...
	@Test(groups = { "smoke" }, priority = 1, description = "TC_03_Create New User in Application")
	public void TC_03_signUPIntoApplication_using_Registration() {
	...
	@Test(groups = { "regression" }, priority = 0, description = "TC_03_Direct_Search")
	public void TC_03_Direct_Search() {
		HomePagePopUp signUp = new HomePagePopUp(getDriver()).navigateToURL();
